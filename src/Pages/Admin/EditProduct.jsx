...
// import { getProductDataAPI } from "../../store/Product/product.api";
...
// const totalProducts = [...kids,...compGlassData]
...
//     setProdDetails((prodDetails)=>({...prodDetails,[name]:value}))
//   }

// //   const getProdDetails=()=>{

//       const filteredProd=  totalProducts?.filter((el)=>(
//          el.id === id
//       ))
